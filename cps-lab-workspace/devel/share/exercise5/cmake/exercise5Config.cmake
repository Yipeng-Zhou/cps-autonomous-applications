...
if("TRUE" STREQUAL "TRUE")
  set(exercise5_SOURCE_PREFIX /home/cps-student-2/cps-lab-workspace/src/exercise5)
  set(exercise5_DEVEL_PREFIX /home/cps-student-2/cps-lab-workspace/devel)
  ...
  set(exercise5_INSTALL_PREFIX /home/cps-student-2/cps-lab-workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'cps-student-2 <cps-student-2@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'exercise5' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cps-student-2/cps-lab-workspace/src/exercise5/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT exercise5_NUM_DUMMY_TARGETS)
      set(exercise5_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::exercise5::wrapped-linker-option${exercise5_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR exercise5_NUM_DUMMY_TARGETS "${exercise5_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::exercise5::wrapped-linker-option${exercise5_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND exercise5_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cps-student-2/cps-lab-workspace/devel/lib;/home/cps-student-2/cps-lab-workspace/devel/lib;/opt/ros/melodic/lib)
