...
message(STATUS "exercise7: 0 messages, 0 services")
...
### Generating Module File
_generate_module_eus(exercise7
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/exercise7
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(exercise7_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(exercise7_generate_messages exercise7_generate_messages_eus)

# add dependencies to all check dependencies targets

# target for backward compatibility
add_custom_target(exercise7_geneus)
add_dependencies(exercise7_geneus exercise7_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS exercise7_generate_messages_eus)
...
### Generating Module File
_generate_module_nodejs(exercise7
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/exercise7
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(exercise7_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(exercise7_generate_messages exercise7_generate_messages_nodejs)

# add dependencies to all check dependencies targets

# target for backward compatibility
add_custom_target(exercise7_gennodejs)
add_dependencies(exercise7_gennodejs exercise7_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS exercise7_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/exercise7)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/exercise7
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(exercise7_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/exercise7)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/exercise7
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(exercise7_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/exercise7)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/exercise7\")")
  # install generated code
  install(
