...
if("TRUE" STREQUAL "TRUE")
  set(f110_simulator_SOURCE_PREFIX /home/cps-student-2/simulator/src/f110_simulator)
  set(f110_simulator_DEVEL_PREFIX /home/cps-student-2/simulator/devel)
  ...
  set(f110_simulator_INSTALL_PREFIX /home/cps-student-2/simulator/install)
...
if(NOT "/home/cps-student-2/simulator/src/f110_simulator/include " STREQUAL " ")
  set(f110_simulator_INCLUDE_DIRS "")
  set(_include_dirs "/home/cps-student-2/simulator/src/f110_simulator/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'f110_simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cps-student-2/simulator/src/f110_simulator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cps-student-2/simulator/devel/lib;/home/cps-student-2/simulator/devel/lib;/opt/ros/melodic/lib)
